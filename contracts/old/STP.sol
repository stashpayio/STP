...
contract STP is Token {
    ...
    {
        /* Init addresses */
        sale = 0xB155c16c13FC1eD2F015e24D6C7Ae8Cc38cea74E;
        adviserAndBounty = 0xF74b4559D51A6ED70DaB6CaEE6Ffcb444288d9b8;
    ...
    function multiDistributeAmount(address[] data, uint256 amount) 
    public
    onlyUnfrozen(sale) 
    onlyOwner 
    {
    ...
    function transferAdviserBounty(address addr, uint256 amount, bool freeze) 
    public    
    onlyOwner 
    {   
        // adviser amounts are frozen
